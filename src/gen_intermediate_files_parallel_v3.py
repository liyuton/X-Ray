...
def gen_intermediate_files(pid):
    ...
    years_list = [year for year in years_list if year >= 2008 and year <= 2010]
...
if __name__=="__main__":
    if len(sys.argv) < 2:
        print("Usage: python gen_intermediate_files_v2_param.py <pid>")
        sys.exit(1)
